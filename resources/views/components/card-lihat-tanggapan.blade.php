	...
	<div class="col-md-8">
         ...
         <div class="card-body">  
			...
			<b class="text-primary">
				<i class="fas fa-user"></i> {{ $pengaduan->masyarakat->username }} <i class="bullet"></i> <span class="text-uppercase">{{ $pengaduan->created_at->diffForHumans() }}</span>
			</b>
               <div class="text-dark">
			...
			<div class="form-group">
                      <div class="input-group">
                        ...
                        <div class="input-group-append">
                          <button class="btn btn-primary" type="@php if($pengaduan->status == 'proses' || $pengaduan->status == 'selesai'){ echo 'submit'; }else{ echo 'button'; } @endphp">
