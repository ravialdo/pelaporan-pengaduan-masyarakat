                        ...
                        <form method="post" action="{{ route('tanggapan.store') }}">
                              ...
                              <div class="form-group">
                                    <div class="input-group">
                                          <textarea name="tanggapan" class="form-control @error('tanggapan') is-invalid @enderror" placeholder="Ketikan tanggapan anda.." {{ session('level')=='admin' ? 'readonly' : '' }}></textarea>
